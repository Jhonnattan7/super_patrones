...
Cada patrón se explica siguiendo una estructura de **5 puntos obligatorios**:

1. **El Problema** — caso de negocio real antes del patrón
2. **La Solución** — explicación conceptual + diagrama UML
3. **Código Mínimo** — esqueleto en PHP (~15-25 líneas)
...
```
super_patrones/
├── index.html            ← Página de inicio + tabla de aportes del grupo
├── prototype/
│   ├── index.html        ← Explicación del patrón Prototype
│   └── diagrama.png      ← Diagrama UML de clases
└── flyweight/
    ├── index.html        ← Explicación del patrón Flyweight
    └── diagrama.png      ← Diagrama UML de clases
```
...
| Subgrupo | Patrón | Carpeta |
|----------|--------|---------|
| Subgrupo A | Prototype | `prototype/` |
| Subgrupo B | Flyweight | `flyweight/` |
